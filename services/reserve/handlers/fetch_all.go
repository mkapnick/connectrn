...
const (
	...
	FetchAllErrCode = "reserve.fetchall.error"
	// FetchAllBadDataCode code
	FetchAllBadDataCode = "reserve.fetchall.bad_data"
)

// FetchAll reserve dates
func FetchAll(bs reserve.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		*/
		...
		log.Printf("successfully fetched all reserve dates id in %s", date)
		return
	}
}
